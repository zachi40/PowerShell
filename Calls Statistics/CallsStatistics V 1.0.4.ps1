...
$ListSubject.Keys | sort @{Expression={$_ -eq "אנא בחר נושא מהרשימה"}; Ascending=$false}
...
$MainTopicBox.SetHorizontalExtent=$True
...
$version = GenerateLabel -text 'V 1.1' -x '2' -y '167'
